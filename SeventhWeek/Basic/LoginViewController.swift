...
class LoginViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        viewModel.outputValidText.lazyBind { [self] in
            validationLabel.text = $0
        }
        viewModel.outputValidTextColor.lazyBind { [self] in
            validationLabel.textColor = $0 ? .blue : .red
        }
        viewModel.outputValidButton.bind { [self] in
